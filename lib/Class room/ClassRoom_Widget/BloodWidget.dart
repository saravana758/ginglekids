...
class BloodWidget extends StatelessWidget {
  ...
  BloodWidget({required this.bloodgroup});
  @override
  Widget build(BuildContext context) {
    ...
    return Padding(
          ...
          children: <Widget>[
            Padding(
             padding: EdgeInsets.only(left: screenWidth * 0.02),
              child: Icon(Icons.bloodtype,  size: screenWidth * 0.08, color: Color.fromRGBO(117, 94, 172, 1),),
            ), 
      ...
      'Blood group',
      style: TextStyle(
        color: Color.fromRGBO(0, 0, 0, 1), // Use your color variable here
        fontFamily: 'Poppins',
